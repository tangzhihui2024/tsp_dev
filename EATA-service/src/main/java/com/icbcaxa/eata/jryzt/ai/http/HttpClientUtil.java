...
public class HttpClientUtil {
    ...
    public String doGet(CloseableHttpClient httpclient, String baseUrl, Map<String, String> params) {
        ...
        System.out.println("http baseUrl : {}," + baseUrl);
        String url = baseUrl;
        ...
        try {
            ...
            System.out.println("Http get request set entity failure.");
            throw new RuntimeException("httpclientUtil exception", e);
        } catch (Exception e) {
            System.out.println("Http get request to {} fail,exception msg {}," + url + "," + e.getMessage());
            throw new RuntimeException("httpclientUtil exception", e);
        } finally {
            System.out.println("http get request cost:{} ms," + (System.currentTimeMillis() - startTime));
        }
    }

    public String doGetWithHeader(CloseableHttpClient httpclient, String baseUrl, Map<String, String> headers) {
        if (StringUtils.isBlank(baseUrl)) {
            throw new NullPointerException("Parameter url is null.");
        }
        if (httpclient == null) {
        ...
        System.out.println("http url : {}," + baseUrl);
        ...
        try {
            ...
            System.out.println("Http get request to {} fail,exception msg {}," + baseUrl + "," + e.getMessage());
            throw new RuntimeException("httpclientUtil exception", e);
        } finally {
            System.out.println("http get request cost:{} ms," + (System.currentTimeMillis() - startTime));
        }
    ...
    private void setHttpHeaders(HttpRequestBase get, Map<String, String> headers) {
        if (headers != null) {
            System.out.println("Set http header:{}," + headers);
    ...
    private String buildGetParams(Map<String, String> params) {
        if (params != null) {
            System.out.println("Set get params:{}," + params);
    ...
    public String doGet(String baseUrl, Map<String, String> params, HttpHost proxy) {
        return doGet(baseUrl, params, null, proxy);
    }

    public String doGet(String baseUrl, Map<String, String> params) {
        return doGet(baseUrl, params, null, null);
    }

    public String doGet(String baseUrl, Map<String, String> params, Map<String, String> headers, HttpHost proxy) {
        if (StringUtils.isBlank(baseUrl)) {
            return null;
        }
        System.out.println("http baseUrl:{}, params:{}," + baseUrl + "," + params);
        String url = baseUrl + "?" + buildGetParams(params);
        return doGetWithHeader(buildHttpClient(proxy), url, headers);
    }
    ...
    public String httpPostJson(String url, String json) {
        System.out.println("http url:{}, params:{}," + url + "," + json);
        return httpPostRequest(buildHttpClient(), url, json, null);
    }

    public String httpPostJson(String url, String json, Map<String, String> headers, HttpHost proxy) {
        //logger.info("平安一账通 http url:{}, params:{}, headers:{}," + url + "," + json + "," + headers);
        return httpPostRequest(buildHttpClient(proxy), url, json, headers);
    }

    public String httpPostJson(String url, String json, Map<String, String> headers) {
        System.out.println("http url:{}, params:{}, headers:{}," + url + "," + json + "," + headers);
        return httpPostRequest(buildHttpClient(), url, json, headers);
    }

    public String httpPostJson(String url, Map<String, String> params) {
        System.out.println("http url:{}, params:{}," + url + "," + params);
    ...
    public String httpPostString(CloseableHttpClient httpclient, String url, String requestStr,
        ...
        try {
            ...
            System.out.println("Http post String set entity failure.");
            throw new RuntimeException("httpclientUtil post exception", e);
        } catch (Exception e) {
            System.out.println("Http post String to {} fail,exception msg {}," + url + "," + e.getMessage());
            throw new RuntimeException("httpclientUtil post exception", e);
        } finally {
            System.out.println("http post String cost:{} ms," + (System.currentTimeMillis() - startTime));
        }
    }
    ...
    public String httpPostRequest(CloseableHttpClient httpclient, String url, String json,
        ...
        try {
            ...
            //System.out.println("Http post request set entity failure.");
            throw new RuntimeException("httpclientUtil post exception", e);
        } catch (Exception e) {
            //System.out.println("Http post request to {} fail,exception msg {}," + url + "," + e.getMessage());
            throw new RuntimeException("httpclientUtil post exception", e);
        } finally {
            //System.out.println("http post request cost:{} ms," + (System.currentTimeMillis() - startTime));
        }
    }
    ...
    public String httpPostRequest(CloseableHttpClient httpclient, String url, Map<String, String> params,
        ...
        System.out
                .println("Http post request [{}] by params:{} and headers:{}," + new Object[] { url, params, headers });
    ...
    private String handleResponse(CloseableHttpResponse response) throws IOException {
        try {
            ...
            System.out.println("http post response code : {}," + statusCode);
            if (statusCode == HttpStatus.SC_OK) {
                String result = EntityUtils.toString(response.getEntity(), "UTF-8");
                System.out.println("http post response:{}," + result);
                return result;
            } else {
    ...
    public String httpPostRequest(String url, Map<String, String> params, Map<String, String> headers) {
        ...
        System.out
                .println("Http post request url:{} by params:{} and headers:{}," + new Object[] { url, params, headers });
    ...
    public String doPut(CloseableHttpClient httpclient, String url, Map<String, String> params,
        ...
        System.out
                .println("Http put request [{}] by params:{} and headers:{}," + new Object[] { url, params, headers });
        ...
        try {
            ...
            System.out.println("Http put request set entity failure.");
            throw new RuntimeException("httpclientUtil put exception", e);
        } catch (Exception e) {
            System.out.println("Http put request to {} fail,exception msg {}," + url + "," + e.getMessage());
            throw new RuntimeException("httpclientUtil put exception", e);
        } finally {
            System.out.println("http put request cost:{} ms," + (System.currentTimeMillis() - startTime));
        }
    }
    ...
    public String doPut(String url, String json, Map<String, String> headers) {
        ...
        System.out.println("Http post request url:{} by json:{} and headers:{}," + new Object[] { url, json, headers });
        String result = doPut(buildHttpClient(), url, json, headers);
        return result;
    }

    public String doPut(CloseableHttpClient httpclient, String url, String json, Map<String, String> headers) {
        if (httpclient == null) {
            throw new NullPointerException("Parameter httpclient is null.");
        }
        System.out.println("Http put request [{}] by json:{} and headers:{}," + new Object[] { url, json, headers });
        HttpPut put = new HttpPut(url);
        // set request http headers
        setHttpHeaders(put, headers);
    ...
    /**
     * Titel 提交HTTP请求，获得响应(application/x-www-form-urlencoded) Description 使用NameValuePair封装参数，适用于下载文件。
     *
     * @param serviceURI
     *            接口地址
     * @param timeOut
    ...
    public CloseableHttpResponse submitPostHttpReq(final String serviceURI, final int timeOut,
        ...
        System.out.println("即将发起HTTP请求！serviceURI：" + serviceURI);
        // 遍历封装参数
        ...
        try {
            ...
            System.out.println("创建UrlEncodedFormEntity异常！" + e.getMessage());
        ...
        // 提交请求、获取响应
        System.out.println("提交http请求！serviceURI：" + serviceURI);
        CloseableHttpClient httpclient = buildHttpClient();
        CloseableHttpResponse response = null;
        try {
            response = httpclient.execute(httpPost);
        } catch (IOException e) {
            System.out.println("httpclient.execute异常！" + e.getMessage());
            throw new Exception(e);
        }
    ...
    private CloseableHttpClient buildHttpClient(HttpHost proxy) {
        if (proxy == null) {
            ...
            if (connTimeout > 0 && connRequestTimeout > 0 && socketTimeout > 0) {
                return this.getClientFactory().build(connTimeout, connRequestTimeout, socketTimeout, proxy);
            } else {
                return this.getClientFactory().build(proxy);
            }
        }
    }

    private void setHttpEntityRequest(HttpEntityEnclosingRequestBase request, Map<String, String> params) {
        if (params != null) {
            System.out.println("Set http entity params:{}," + params);
            List<NameValuePair> nvps = new ArrayList<NameValuePair>();
            for (Map.Entry<String, String> e : params.entrySet()) {
                String name = e.getKey();
                String value = e.getValue();
